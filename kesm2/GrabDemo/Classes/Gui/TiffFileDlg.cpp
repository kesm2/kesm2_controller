	...
	: CDialog(CTiffFileDlg::IDD, pParent)
{
	...
	m_App = AfxGetApp();
	m_CompressionLevel = m_App->GetProfileInt(_T("SapFile"), _T("Tiff Compression Level"), compressionLevel);
	m_CompressionType = m_App->GetProfileInt(_T("SapFile"), _T("Tiff Compression Type"), compressionType);
}
...
void CTiffFileDlg::OnOK() 
{
	...
	m_App->WriteProfileInt(_T("SapFile"), _T("Tiff Compression Level"), m_CompressionLevel);
	m_App->WriteProfileInt(_T("SapFile"), _T("Tiff Compression Type"), m_CompressionType);
}
