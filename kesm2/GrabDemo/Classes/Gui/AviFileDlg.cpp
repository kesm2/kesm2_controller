	...
	: CDialog(CAviFileDlg::IDD, pParent)
{
	...
	m_App = AfxGetApp();
	m_FirstFrame = m_App->GetProfileInt(_T("SapFile"), _T("Avi First Frame"), firstFrame);
	m_CompressionLevel = m_App->GetProfileInt(_T("SapFile"), _T("Avi Compression Level"), compressionLevel);
	m_CompressionType = m_App->GetProfileInt(_T("SapFile"), _T("Avi Compression Type"), compressionType);
...
void CAviFileDlg::OnOK() 
{
	...
	m_App->WriteProfileInt(_T("SapFile"), _T("Avi First Frame"), m_FirstFrame);
	m_App->WriteProfileInt(_T("SapFile"), _T("Avi Compression Level"), m_CompressionLevel);
	m_App->WriteProfileInt(_T("SapFile"), _T("Avi Compression Type"), m_CompressionType);
}
