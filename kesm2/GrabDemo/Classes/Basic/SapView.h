...
#ifdef __BORLANDC__
   SapView(SapBuffer *pBuffer = NULL, void* hWnd = SapHwndDesktop, SapViewCallback pCallback = NULL, void *pContext = NULL);
   SapView(SapDisplay *pDisplay, SapBuffer *pBuffer, void* hWnd = SapHwndDesktop, SapViewCallback pCallback = NULL, void *pContext = NULL);
#else
