 ...
 *
 *	    gcc -DC_GNU32=296 -DOS_LINUX_GNU xclibel3.c xclib_i386.a -o xclibel3 -lm `pkg-config gtk+-2.0 --cflags --libs`
 *	    gcc -DC_GNU64=402 -DOS_LINUX_GNU xclibel3.c xclib_i386.a -o xclibel3 -lm `pkg-config gtk+-2.0 --cflags --libs`
 *    
 *      Compile with GCC with PXIPL as:
 *
 *	    gcc -DC_GNU32=296 -DOS_LINUX_GNU xclibel3.c pxipl_i386.a xclib_i386.a -o xclibel3 -lm `pkg-config gtk+-2.0 --cflags --libs`
 *	    gcc -DC_GNU64=402 -DOS_LINUX_GNU xclibel3.c pxipl_i386.a xclib_i386.a -o xclibel3 -lm `pkg-config gtk+-2.0 --cflags --libs`
 *
 *	Run as:
 *	    ./xclibel3
 *
