/*
 *
 *	xclibsv.h	External	04-Aug-2005
 *
 *	Copyright (C)  1999-2005  EPIX, Inc.  All rights reserved.
 *
...
/*
 * Library version ID  (Internal flag: SFUID!)
 *
...
struct xcdevinfo {
     ...
     */
    uint16  fpgalevel;		/* for PIXCI(R) CL2/E1/E4/E1DB			   */
    uint16  pcblevel;		/* for PIXCI(R) CL2/E1/E4/E1DB			   */
    uint16  cam0code;		/* for PIXCI(R) CL2/E1/E4/E1DB			   */
    uint16  cam1code;		/* for PIXCI(R) CL2/E1/E4/E1DB			   */
    uint16  rsvd[16];
    uint32  rsvd2[16];
...
#define XCMOS_DEVPARMS		(PXMOS_DDCH+13+PXMAX_UNITS+PXMAX_UNITS+32+32+32)
