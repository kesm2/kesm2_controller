 ...
 *	cameras. Example assumes Windows 95/98/ME/NT/2000/XP.
 *
 ...
 *	    10. Under C/C++-> General-> Additional Include Directories specify 'C:\XCLIB'.
 *	    11. Under C/C++-> Precompiled Headers-> Create/Use Precompiled Header
 *		select 'Not Using Precompiled Headers'.
 *	    12. Under Linker-> General-> Additional Include Directories specify 'C:\XCLIB'.
