/*
 *
 *	pxipl.h 	External	23-Dec-2005
 *
 *	Copyright (C)  1988-2005  EPIX, Inc.  All rights reserved.
 *
 ...
 * pxi8sig.c
 */
_cDcl(_dllpxipl,_cfunfcc,int) pxip8_signature(pxabortfunc_t**,pximage_s *ip,uint16 *sigp);
...
_cDcl(_dllpxipl,_cfunfcc,int)  pxio8_aviwriteseq(pxabortfunc_t**,pximage3_s *ip,
			pximage_s *lip,char *pathname,int bits,pximfileinfo_s *parmp);
_cDcl(_dllpxipl,_cfunfcc,int)  pxio8_aviodmlwriteseq(pxabortfunc_t**,pximage3_s *ip,
			pximage_s *lip,char *pathname,int bits,pximfileinfo_s *parmp);
...
_cDcl(_dllpxipl,_cfunfcc,int)  pxio8_aviodmlwriteseqinit(pxabortfunc_t**,void **handlep,char *pathname,
			pximage_s *ip,pximage_s *lip,int bits,pximfileinfo_s *parmp,long nimages);
