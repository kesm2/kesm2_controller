/*
 *
 *	xclibvs.h	External	02-Mar-2005
 *
...
/*
 * For PIXCI(R) D/D24/D32/A/D2X/CL1/CL2/E1/E4/E1DB/SI/CL3SD imaging boards.
...
#define XCMOS_DXXFORMAT    (PXMOS_DDCH+6+3+8 +4 +2*4+8)
