...
struct xcdevinfo {
     ...
     */
    uint16  fpgalevel;		/* for PIXCI(R) CL2/E1			      */
    uint16  pcblevel;		/* for PIXCI(R) CL2/E1			      */
    uint16  cam0code;		/* for PIXCI(R) CL2/E1			      */
    uint16  cam1code;		/* for PIXCI(R) CL2/E1			      */
    uint16  rsvd[16];
    uint32  rsvd2[16];
