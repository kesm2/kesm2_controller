 ...
 *
 *	For PIXCI(R) D, A, D24, D32, D2X, D3X, CL1, CL2, E1, CL3SD, and SI imaging boards,
 ...
 *
 *	    gcc -DC_GNU32=296 -DOS_LINUX_GNU xclibel1.c xclibi86.a -lm
 *	    gcc -DC_GNU64=400 -DOS_LINUX_GNU xclibel1.c xclibi86.a -lm
 *
 *  Compile with GCC with PXIPL as:
 *
 *	    gcc -DC_GNU32=296 -DOS_LINUX_GNU xclibel1.c pxipli86.a xclibi86.a -lm
 *	    gcc -DC_GNU64=400 -DOS_LINUX_GNU xclibel1.c pxipli86.a xclibi86.a -lm
 *
 *	Run as:
 *	    ./a.out
 *
