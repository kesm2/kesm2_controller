...
public:
	...
	//jwyoo, hwang, 02-29-2016
	bool GetnSetpDCapture();
	LRESULT SendMessage2DCapture(UINT msg, WPARAM wParam = 0U, LPARAM lParam = 0L);
	LRESULT PostMessage2DCapture(UINT msg, WPARAM wParam = 0U, LPARAM lParam = 0L);
